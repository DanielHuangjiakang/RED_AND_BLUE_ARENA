...
class Entity
{
	unsigned int id; // used to uniquely identify entities
    std::string name; // like player1, player2, block1, etc. to easily identify entities.
...
// Copy-pasted code from A1, change in case for any incompatiability
